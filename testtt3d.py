...
range_values = measurements_array[:, 0]
azimuth_values = measurements_array[:, 1]
elevation_values = measurements_array[:, 2]
...
# Plot measurements
ax.scatter(range_values, azimuth_values, elevation_values, c='b', marker='o', label='Measurements')

# Plot target
ax.scatter(*target_measurement, c='r', marker='x', label='Target')

# Plot most likely associated measurement
most_likely_measurement = measurements[most_likely_index]
ax.scatter(*most_likely_measurement, c='g', marker='^', label='Most Likely Associated')

# Set labels and title
ax.set_xlabel('Range')
ax.set_ylabel('Azimuth')
ax.set_zlabel('Elevation')
ax.set_title('3D Plot of Measurements and Target')
